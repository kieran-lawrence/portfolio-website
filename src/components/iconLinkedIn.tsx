export default function IconLinkedIn() {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="group">
			<title>My LinkedIn Profile</title>
			<path
				className="fill-text-light dark:fill-text-dark group-hover:fill-bg-dark dark:group-hover:fill-bg-light transition duration-250"
