  ...
  return (
        <PortfolioContainer>
            <PortfolioItemList>
                ...
                <PortfolioItem src='images/thiswebsite.png' text='This website!' desc='I made this website using React, it is an example of my skills to date. This site was made in React and is actually my second version of the site.'  href='https://github.com/nfctargus/my-website-v1' ariaLabel='GitHub Project Repo' />
            </PortfolioItemList>
        </PortfolioContainer>
  )
}
