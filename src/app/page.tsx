...
export default function Home() {
	return (
		<main className="flex flex-col items-center justify-center transition duration-250">
			<div
				id="intro"
				className="flex h-[80vh] w-screen flex-col items-center justify-center gap-4 md:h-[25vh] md:gap-8"
			>
			...
			<div className="relative h-[6rem] w-screen md:h-[23.5rem] 2xl:h-[40rem]">
				<CloudsBackgroundTop />
			</div>
