				...
				<div className="print:text-text-light bg-bg-light dark:bg-bg-dark flex w-full flex-col items-center justify-center gap-6 px-8 pb-4 print:gap-2 print:bg-white print:p-0">
					...
					<section className="flex w-full flex-col md:w-1/2 print:w-full">
						...
						<p className="print:text-sm">
							Innovative and results-driven software developer with a strong
							foundation in full-stack development, cloud infrastructure, and system
							engineering. Proficient in modern frameworks like React, Next.js, and
							NestJS, with hands-on experience deploying scalable solutions on AWS.
						</p>
					</section>
						...
						<div className="flex flex-col gap-1 print:text-sm">
							<div>
								...
								<ul className="ml-2 list-inside list-disc">
									<li>
										Developed and enhanced front-end features for interactive
										user experiences.
									</li>
									<li>Integrated backend systems and AWS cloud services.</li>
									<li>
										Contributed to the successful launch of The Nightly with
										over 5M monthly views.
									</li>
								</ul>
							</div>
							<div>
							...
							<div>
								...
								<ul className="ml-2 list-inside list-disc">
									...
									<li>
										Mentored new hires and coordinated with vendors for
										escalations.
									</li>
								</ul>
							</div>
